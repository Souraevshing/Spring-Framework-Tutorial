...
public class UseProgrammer {
    ...
    public static void main(String[] args) {
        ApplicationContext context = new ClassPathXmlApplicationContext("/com/multiple/configuration/resources/application-conf.xml");
        Programmer programmer = context.getBean("programmer", Programmer.class);
        Laptop laptop = programmer.getLaptop();
        System.out.println("=================");
